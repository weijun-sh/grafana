...
__webpack_require__.r(__webpack_exports__);
 __webpack_require__.d(__webpack_exports__, {
   "FolderLibraryPanelsPage": () => ( FolderLibraryPanelsPage),
 ...
 var react_use__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("./.yarn/__virtual__/react-use-virtual-00326e70ba/0/cache/react-use-npm-17.3.2-a032cbeb01-7379460f51.zip/node_modules/react-use/esm/useAsync.js");
 var _core_components_Page_Page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./public/app/core/components/Page/Page.tsx");
 var _core_selectors_navModel__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./public/app/core/selectors/navModel.ts");
 var _library_panels_components_LibraryPanelsSearch_LibraryPanelsSearch__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./public/app/features/library-panels/components/LibraryPanelsSearch/LibraryPanelsSearch.tsx");
 var _library_panels_components_OpenLibraryPanelModal_OpenLibraryPanelModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./public/app/features/library-panels/components/OpenLibraryPanelModal/OpenLibraryPanelModal.tsx");
 var _state_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./public/app/features/folders/state/actions.ts");
 var _state_navModel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./public/app/features/folders/state/navModel.ts");
...
const mapStateToProps = (state, props) => {
  ...
  return {
    navModel: (0,_core_selectors_navModel__WEBPACK_IMPORTED_MODULE_8__ .h)(state.navIndex, `folder-library-panels-${uid}`, (0,_state_navModel__WEBPACK_IMPORTED_MODULE_6__ ._)(1)),
    folderUid: uid,
    folder: state.folder
  };
};
...
const mapDispatchToProps = {
  getFolderByUid: _state_actions__WEBPACK_IMPORTED_MODULE_5__ .Pb
};
...
function FolderLibraryPanelsPage(_ref) {
  ...
  const {
    loading
  } = (0,react_use__WEBPACK_IMPORTED_MODULE_9__ .Z)(async () => await getFolderByUid(folderUid), [getFolderByUid, folderUid]);
  const [selected, setSelected] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(undefined);
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_core_components_Page_Page__WEBPACK_IMPORTED_MODULE_2__ .Z, {
    navModel: navModel,
    children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_core_components_Page_Page__WEBPACK_IMPORTED_MODULE_2__ .Z.Contents, {
      isLoading: loading,
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_library_panels_components_LibraryPanelsSearch_LibraryPanelsSearch__WEBPACK_IMPORTED_MODULE_3__ .N, {
        onClick: setSelected,
        currentFolderId: folder.id,
        showSecondaryActions: true,
        showSort: true,
        showPanelFilter: true
      }), selected ? (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_library_panels_components_OpenLibraryPanelModal_OpenLibraryPanelModal__WEBPACK_IMPORTED_MODULE_4__ .b, {
 ...
 const __WEBPACK_DEFAULT_EXPORT__ = (connector(FolderLibraryPanelsPage));
