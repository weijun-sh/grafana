...
class PanelCtrl {
 ...
 var _grafana_ui_src_components_GraphNG_nullInsertThreshold__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./packages/grafana-ui/src/components/GraphNG/nullInsertThreshold.ts");
 var app_core_config__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./public/app/core/config.ts");
 var app_core_time_series2__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./public/app/core/time_series2.ts");
...
class DataProcessor {
  ...
  getSeriesList(options) {
    ...
    for (let i = 0; i < dataList.length; i++) {
      ...
      series = (0,_grafana_ui_src_components_GraphNG_nullInsertThreshold__WEBPACK_IMPORTED_MODULE_3__ .w)(series, timeField.name);
      timeField = (0,_grafana_data__WEBPACK_IMPORTED_MODULE_1__.getTimeField)(series).timeField; 
  ...
  toTimeSeries(field, alias, dataFrameIndex, fieldIndex, datapoints, index, range) {
    ...
    const series = new app_core_time_series2__WEBPACK_IMPORTED_MODULE_5__ .Z({
      datapoints: datapoints || [],
      alias: alias,
      color: (0,_grafana_data__WEBPACK_IMPORTED_MODULE_1__.getColorForTheme)(color, app_core_config__WEBPACK_IMPORTED_MODULE_4__ .ZP.theme),
