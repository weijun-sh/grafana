...
__webpack_require__.d(__webpack_exports__, {
  "OrgDetailsPage": () => (/* binding */ OrgDetailsPage),
  "default": () => (/* binding */ org_OrgDetailsPage)
});
...
;// CONCATENATED MODULE: ./public/app/features/org/OrgProfile.tsx
var _Button;
...
const OrgProfile = _ref => {
  ...
  const canWriteOrg = core/* contextSrv.hasPermission */.Vt.hasPermission(types/* AccessControlAction.OrgsWrite */.bW.OrgsWrite);
  return /*#__PURE__*/(0,jsx_runtime.jsx)(src.Form, {
    ...
    children: _ref3 => {
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsxs)(src.FieldSet, {
        ...
        }), _Button || (_Button = /*#__PURE__*/(0,jsx_runtime.jsx)(src.Button, {
          type: "submit",
...
/* harmony default export */ const org_OrgProfile = (OrgProfile);
// EXTERNAL MODULE: ./public/app/features/org/state/actions.ts
var actions = __webpack_require__("./public/app/features/org/state/actions.ts");
// EXTERNAL MODULE: ./public/app/features/org/state/reducers.ts
var reducers = __webpack_require__("./public/app/features/org/state/reducers.ts");
;// CONCATENATED MODULE: ./public/app/features/org/OrgDetailsPage.tsx
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class OrgDetailsPage extends react.PureComponent {
  ...
  render() {
    ...
    const canReadOrg = core/* contextSrv.hasPermission */.Vt.hasPermission(types/* AccessControlAction.OrgsRead */.bW.OrgsRead);
    const canReadPreferences = core/* contextSrv.hasPermission */.Vt.hasPermission(types/* AccessControlAction.OrgsPreferencesRead */.bW.OrgsPreferencesRead);
    const canWritePreferences = core/* contextSrv.hasPermission */.Vt.hasPermission(types/* AccessControlAction.OrgsPreferencesWrite */.bW.OrgsPreferencesWrite);
    return /*#__PURE__*/(0,jsx_runtime.jsx)(Page/* default */.Z, {
      navModel: navModel,
      children: /*#__PURE__*/(0,jsx_runtime.jsx)(Page/* default.Contents */.Z.Contents, {
        isLoading: isLoading,
        children: !isLoading && /*#__PURE__*/(0,jsx_runtime.jsxs)(src.VerticalGroup, {
          spacing: "lg",
          children: [canReadOrg && /*#__PURE__*/(0,jsx_runtime.jsx)(org_OrgProfile, {
            onSubmit: this.onUpdateOrganization,
            orgName: organization.name
          }), canReadPreferences && /*#__PURE__*/(0,jsx_runtime.jsx)(SharedPreferences/* default */.Z, {
            resourceUri: "org",
...
function mapStateToProps(state) {
  return {
    navModel: (0,navModel/* getNavModel */.h)(state.navIndex, 'org-settings'),
    organization: state.organization.organization
  };
}

const mapDispatchToProps = {
  loadOrganization: actions/* loadOrganization */.RF,
  setOrganizationName: reducers/* setOrganizationName */.xR,
  updateOrganization: actions/* updateOrganization */.FV
};
/* harmony default export */ const org_OrgDetailsPage = ((0,es.connect)(mapStateToProps, mapDispatchToProps)(OrgDetailsPage));
