"use strict";
(self["webpackChunkgrafana"] = self["webpackChunkgrafana"] || []).push([[2341],{
...
const PlaylistEditPage = _ref => {
  ...
  const {
    playlist,
    loading
  } = (0,_usePlaylist__WEBPACK_IMPORTED_MODULE_8__ .Z)(match.params.id);

  const onSubmit = async playlist => {
    await (0,_api__WEBPACK_IMPORTED_MODULE_6__ .CE)(match.params.id, playlist);
...
const mapStateToProps = state => ({
 ...
 const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_redux__WEBPACK_IMPORTED_MODULE_1__.connect)(mapStateToProps)(PlaylistEditPage));
