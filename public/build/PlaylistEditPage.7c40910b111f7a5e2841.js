...
const PlaylistEditPage = _ref => {
  ...
  const {
    playlist,
    loading
  } = (0,_usePlaylist__WEBPACK_IMPORTED_MODULE_8__/* .usePlaylist */ .Z)(match.params.id);

  const onSubmit = async playlist => {
    await (0,_api__WEBPACK_IMPORTED_MODULE_6__/* .updatePlaylist */ .CE)(match.params.id, playlist);
